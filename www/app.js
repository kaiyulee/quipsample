...
/******/ 	var hotCurrentHash = "d35e6aca59d19f3517e7"; // eslint-disable-line no-unused-vars
	    ...
	    render: function() {
	        return (
	            React.createElement("ul", {className: "list"}, 
	                React.createElement(Item, {data: this.state.data})
	            )
	        );
	    }
	});
	...
	var Item = React.createClass({displayName: "Item",
	    ...
	    render: function() {
	        ...
	        var list = dataJson.map(function(data) {
	            return (
	                React.createElement("li", {className: "item", "data-id": data.id, "data-pid": data.dirid}, 
